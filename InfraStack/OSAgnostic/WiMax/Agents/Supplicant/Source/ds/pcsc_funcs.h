...
#ifdef PCSC_FUNCS
struct scard_data * scard_init(scard_sim_type sim_type, int *err, struct wpa_ssid *config);
struct scard_data * scard_init_by_name(scard_sim_type sim_type, int *scerr,
		char *desired_reader);
...
#define scard_init(s,x,c) NULL
#define scard_init_by_name(s,x,c) NULL
